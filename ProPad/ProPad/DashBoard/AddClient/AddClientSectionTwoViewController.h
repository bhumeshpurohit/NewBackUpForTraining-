...
@interface AddClientSectionTwoViewController : UIViewController<UITextFieldDelegate,UITextViewDelegate>
...
@property (strong, nonatomic) IBOutlet UITextField *txtCustType;
